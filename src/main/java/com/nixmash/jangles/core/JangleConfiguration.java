...
public class JangleConfiguration implements java.io.Serializable {
	...
	public static JangleConfiguration Get() {
		...
		JangleConfiguration config = (JangleConfiguration) JangleCache.GetInstance().Get("JangleConfiguration");
		if (config == null) {
	...
	public JangleConfiguration() {
		...
		try {
			...
			properties.load(getClass().getResourceAsStream(JangleGlobals.Get().ConfigurationFile));
